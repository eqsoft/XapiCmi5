...
/**
 * xApi plugin: functions for calculated fields
 *
 * @author Uwe Kohnle <kohnle@internetlehrer-gmbh.de>
 * @version $Id$
 */ 
class ilXapiCmi5Functions
{
	...
	{
		require_once('./Customizing/global/plugins/Services/Repository/RepositoryObject/XapiCmi5/lib/OAuth.php');
