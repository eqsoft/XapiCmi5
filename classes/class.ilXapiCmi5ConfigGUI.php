...
class ilXapiCmi5ConfigGUI extends ilPluginConfigGUI
{
	...
	private function initTypeForm($create = false)
	{
		...
		$item = new ilTextInputGUI($this->plugin_object->txt('conf_lrs_endpoint'), 'lrs_endpoint');
	...
	private function saveSettings($create = false)
	{
		...
		else
		{
			...
			$this->type->setLrsEndpoint($this->form->getInput("lrs_endpoint"));
			$this->type->setLrsKey($this->form->getInput("lrs_key"));
			$this->type->setLrsSecret($this->form->getInput("lrs_secret"));
